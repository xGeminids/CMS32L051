...
#define _25_AD_INPUT_PGA0                       (0x10U) /* PGAO of PGA0 is used to be the input channel */
#define _26_AD_INPUT_PGA1                       (0x20U) /* PGAO of PGA1 is used to be the input channel */
