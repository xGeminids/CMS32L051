...
void IICA0_Init(void)
{
    ...
    /* ToDo: You can allocate the SCLA0 and SDAA0 to any desired pins 
             with SCLA0PCFG and SDAA0PCFG register */

    /* Set SCLA0, SDAA0 pin */
    PORT->SCLA0PCFG    = 0x19U;			/* allocate SCLA0 to P60 */
    PORT->SDAA0PCFG    = 0x1AU;			/* allocate SDAA0 to P61 */
    PORT->P6          &= 0xFCU;
    PORT->PM6         |= 0x03U;
...
condition */
    ...
    NVIC_EnableIRQ(IICA_IRQn);                          /* enable INTIICA interrupt flag */
}
/***********************************************************************************************************************
