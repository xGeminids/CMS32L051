...
// SCK:  P51/SCK  --> P51/SCK
// MOSI: P16/MOSI <-- P16/MOSI	
// MISO: P17/MISO --> P17/MISO	
//-----------------------------------------------------------------------
...
//=======================================================================
// SPI MODE 0 Master transmission/reception
...
//=======================================================================
	...
	SPI_SlaveInit(SPI_MODE_0);
	
//-----------------------------------------------------------------------
// Master Send and Slave Receive
//-----------------------------------------------------------------------
	SPI_SlaveReceive(srx0_buf, sizeof(srx0_buf));
...
//-----------------------------------------------------------------------
	SPI_SlaveSend(srx0_buf, sizeof(srx0_buf));
...
//=======================================================================
// SPI MODE 3 Master transmission/reception
//   Mode 0: CPOL = 0, CPHA = 0; i.e. DAP = 1, CKP = 1
//   Mode 1: CPOL = 0, CPHA = 1; i.e. DAP = 0, CKP = 1
//   Mode 2: CPOL = 1, CPHA = 0; i.e. DAP = 1, CKP = 0
//   Mode 3: CPOL = 1, CPHA = 1; i.e. DAP = 0, CKP = 0
//=======================================================================
	...
	SPI_SlaveInit(SPI_MODE_3);

//-----------------------------------------------------------------------
// Master Send and Slave Receive
//-----------------------------------------------------------------------
	SPI_SlaveReceive(srx3_buf, sizeof(srx3_buf));
...
// Master Receive and Slave Send
//-----------------------------------------------------------------------
	SPI_SlaveSend(srx3_buf, sizeof(srx3_buf));
