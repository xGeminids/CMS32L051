...
//----------------------------------------------------------------------- 
	...
	printf("Hello, Celebrate You!!\n");
	printf("You have retargetted fputc and fgetc to UART0 Send and Reveive\n");
	printf("The characters you enter in the serial debugging tool will be displayed.\n");
	
	while(1) 
	{
		getchar();  /* received char will echo by fgetc in retarget.c */
	}
}
