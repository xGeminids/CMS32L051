...
//-----------------------------------------------------------------------
#ifndef RTL_SIMULATION
//	printf("Please connect P31/SCK to P51/SCK\n");
//	printf("Please connect P74/MOSI to P16/MOSI\n");
//	printf("Please connect P75/MISO to P11/SDI11\n");
...
//-----------------------------------------------------------------------
	SPI_MasterReceive(mrx0_buf, sizeof(mrx0_buf));
...
// Master Receive and Slave Send
//-----------------------------------------------------------------------
	SPI_MasterReceive(mrx3_buf, sizeof(mrx3_buf));
