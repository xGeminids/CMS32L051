...
//----------------------------------------------------------------------- 
  ...
  PCBZ->CKS0  = 0x8E;    	// FSUB/2^6 = 512Hz
	
//-----------------------------------------------------------------------
// P141/CLKBUZ1 output 
//-----------------------------------------------------------------------
  CLKBUZ1_PORT_SETTING(); // P141/CLKBUZ1
  PCBZ->CKS1  = 0x83;    	// FMAIN/2^3
	
//-----------------------------------------------------------------------
// Measure the high or low level pulse width of P00/TI00
// Please connect P140/CLKBUZ0 to P00/TI00
//-----------------------------------------------------------------------
  width = TM40_Get_PulsePeriod(TM4_CHANNEL_0, TM4_CH0_INPUT_TI00, TM4_PULSE_PERIOD_BOTH);
	printf("P10/TI00 pulse width  = %d fCLK\n", width);
	period = width * 2;
	printf("fCLK frequency = %dHz, error = %6.3f%%\n", period * 512, (((float)(period * 512) - SystemCoreClock) / SystemCoreClock * 100));

//-----------------------------------------------------------------------
// Measure the pulse period of P00/TI00
// Please connect P140/CLKBUZ0 to P00/TI00
//-----------------------------------------------------------------------
