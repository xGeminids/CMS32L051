...
//-----------------------------------------------------------------------
	printf("\n");	
	printf("Please connect No.29 pin(P15/SCL20) to SCL on partner board\n");
	printf("Please connect No.30 pin(P14/SDA20) to SDA on partner board\n");
...
//-----------------------------------------------------------------------
	printf("\n");	
	printf("Please connect No.23 pin(P70/SCL21) to SCL on partner board\n");
	printf("Please connect No.22 pin(P71/SDA21) to SDA on partner board\n");
	printf("Press any key to continue\n");
	getchar();
	printf("\n");	
